...
/**
 * print_data - Prints a data of the ELF header.
 ...
 * @e_ident: A pointer to the array containing an ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - Displays an information contained 
 * ELF header at a start of an the ELF file.
 * @argc: A number of arguments supplied to the program.
 * @argv: An array of the pointers to an arguments.
 *
 * Return: 0 on success.
 *
